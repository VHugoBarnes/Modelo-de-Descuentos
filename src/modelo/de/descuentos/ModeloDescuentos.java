...
public class ModeloDescuentos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modelo de Descuentos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModeloDescuentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModeloDescuentos().setVisible(true);
            }
        });
    }
